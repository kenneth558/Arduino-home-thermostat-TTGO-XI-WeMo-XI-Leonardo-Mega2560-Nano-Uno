You'll need to download three files: the .ino and two .h files.  iF USING ttgo xi/wEmO xi YOU'LL ALSO NEED WHAT YOU'LL FIND AT   https://github.com/wemos/Arduino_XI  (IDE support for TTGO XI/WeMo XI), BUT READ THAT ISSUES SECTION FOR THE BOARDS.TXT FILE MODIFICATION IF YOU COMPILE UNDER LINUX
