...
I use this sketch in the Arduino UNO, Mega2560, Leonardo and Wemo XI (TTGO XI) as my thermostat, and you can easily modify it for humidistat as well.  Currently DHT11, DHT22, and KY-013 sensors only.  Obviously, the DHT sensors can connect to Digital pins while the KY014 can connecto to Analog pins.  
